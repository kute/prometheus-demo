 ...
 */
public class FruitPropertiesConfigAdapter extends PropertiesConfigAdapter<PrometheusProperties>
        implements PrometheusConfig {

    FruitPropertiesConfigAdapter(PrometheusProperties properties) {
        super(properties);
    }
